...
<!--********************MAIN START*********************************-->
<div class="container catalog_flex">
    <!--*******************SPISOK START*******************************-->
    <aside class="spisok">
        <details>
    ...
    <div class="catalog">
        ...
        <div class="catalog-items">
            ...
            <div class="hover" data-id="3" data-name="Mango People T-shirt" data-img="images/3.png" data-price="52.00">
                ...
                <div class="add_flex">
                    <a href="#" class="add" data-id="3">Add to Cart</a>
                </div>
            </div>
            <div class="hover" data-id="4" data-name="Mango People T-shirt" data-img="images/11.png" data-price="52.00">
                ...
                <div class="add_flex">
                    <a href="#" class="add" data-id="4">Add to Cart</a>
                </div>
            </div>
            <div class="hover" data-id="5" data-name="Mango People T-shirt" data-img="images/8.png" data-price="52.00">
                ...
                <div class="add_flex">
                    <a href="#" class="add" data-id="5">Add to Cart</a>
                </div>
            </div>
            <div class="hover" data-id="6" data-name="Mango People T-shirt" data-img="images/12.png" data-price="52.00">
                ...
                <div class="add_flex">
                    <a href="#" class="add" data-id="6">Add to Cart</a>
                </div>
            </div>
            <div class="hover">
                <a href="product.php">
